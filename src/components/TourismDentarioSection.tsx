          ...
          <div className="order-2 lg:order-1 space-y-6 sm:space-y-8">
           ...
           <div className="order-1 lg:order-2">
             <div className="relative bg-gradient-to-br from-white/80 via-white/60 to-white/80 rounded-3xl p-8 backdrop-blur-sm border border-[hsl(var(--gold-leaf))]/20 shadow-2xl">
              ...
              <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center overflow-hidden">
                <div className="text-center space-y-4">
                  <div className="w-20 h-20 bg-[hsl(var(--gold-leaf))]/20 rounded-full flex items-center justify-center mx-auto">
                    <div className="w-8 h-8 bg-[hsl(var(--gold-leaf))] rounded-full"></div>
                  </div>
                  <p className="text-jet/60 dark:text-gray-400 font-vivant text-sm">
                    Imagem do Programa
                    <br />
                    Turismo Dentário
                  </p>
